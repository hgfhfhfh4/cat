...
Profiles:CreateButton({
	...
	Function = function()
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/hgfhfhfh4/cat/'..readfile('catrewrite/profiles/commit.txt')..'/loader.lua', true))(shared.catdata)
		end
	end
})
	...
	Function = function(val, mouse)
		if mouse then
			...
			if shared.VapeDeveloper then
				...
				loadstring(game:HttpGet('https://raw.githubusercontent.com/hgfhfhfh4/cat/'..readfile('catrewrite/profiles/commit.txt')..'/loader.lua', true))()
			end
		end
	end,
